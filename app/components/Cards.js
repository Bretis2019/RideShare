...
function DetailsSvg(){
    return (
        <svg width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff"><g id="SVGRepo_bgCarrier" strokeWidth={0} /><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round" /><g id="SVGRepo_iconCarrier"> <path d="M2 8C2 7.44772 2.44772 7 3 7H21C21.5523 7 22 7.44772 22 8C22 8.55228 21.5523 9 21 9H3C2.44772 9 2 8.55228 2 8Z" fill="#ffffff" /> <path d="M2 12C2 11.4477 2.44772 11 3 11H21C21.5523 11 22 11.4477 22 12C22 12.5523 21.5523 13 21 13H3C2.44772 13 2 12.5523 2 12Z" fill="#ffffff" /> <path d="M3 15C2.44772 15 2 15.4477 2 16C2 16.5523 2.44772 17 3 17H15C15.5523 17 16 16.5523 16 16C16 15.4477 15.5523 15 15 15H3Z" fill="#ffffff" /> </g></svg>
    )
}
    ...
    const elements = user.map((item, index) => (
        ...
        >
            <div className="absolute select-none cursor-grab">
                ...
                <Link href={`/profile/${userIds[index]}`}><div className={"z-50 cursor-pointer absolute top-2 right-2 w-10 h-10 rounded-full Card flex justify-center items-center"}><DetailsSvg /></div></Link>
                ...
                <div className="absolute inset-0 flex flex-col items-start justify-end text-white p-4 md:w-[22svw] w-[95svw] gap-y-4">
                    <div className={"flex justify-between md:w-[20svw] w-[95svw] items-center px-2"}>
                        <h2 className="text-xl font-bold mb-2 self-center capitalize">{item.name}, {item.age}</h2>
